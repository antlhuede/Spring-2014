...
namespace Framework
{
	...
	WindowsSystem::WindowsSystem(HWND parentWindow, const char* windowTitle, int ClientWidth, int ClientHeight)
	{
    ...
    if(parentWindow)
      style = WS_CHILD | WS_VISIBLE;
		...
		AdjustWindowRect(&fullWinRect,			//The rectangle for the full size of the window
						style,	//The style of the window, which must match what is passed in to CreateWindow below
		...
		hWnd = CreateWindow(windowsClassName,	//The class name
			...
			style,				//The style of the window (WS_BORDER, WS_MINIMIZEBOX, WS_MAXIMIZE, etc.)
